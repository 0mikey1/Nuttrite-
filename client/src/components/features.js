    ...
    <div className="container">
      <div className="row">
        <div className="col text-center">
          <h1 className="text-black fs-1 text">What we offer..</h1>
          <p className="text-black fs-6 text">
            {" "}
            We provide the tools our users need to eat properly.{" "}
          </p>
        </div>
      </div>
      <div className="row">
        <div className="col text-center">
          ...
          <h1 className="text-black fs-5 text">Macro-Nutrient Calculator</h1>
          <p className="text-black fs-6 text">
            {" "}
            Calculate how much protein, carbohydrates, and fats you should be
            consuming daily.{" "}
          </p>
        </div>
        <div className="col text-center">
          ...
          <h1 className="text-black fs-5 text">Macro-Friendly Recipes</h1>
          <p className="text-black fs-6 text">
            {" "}
            Interact with a feed of recipes based on your own personlized
            nutritional profile.{" "}
          </p>
        </div>
        <div className="col text-center">
          ...
          <h1 className="text-black fs-5 text">Smart Meal Planner</h1>
          <p className="text-black fs-6 text">
            {" "}
            Drag meals from your personlized feed and drop them in your weekly
            meal plan.{" "}
          </p>
        </div>
      </div>
